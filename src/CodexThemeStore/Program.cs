...
internal sealed class ThemeStoreApp
{
    ...
    private void PrintUsage()
    {
        ...
        Console.WriteLine("  CodexThemeStore.exe list");
        Console.WriteLine("  CodexThemeStore.exe apply dilraba-star");
        Console.WriteLine("  CodexThemeStore.exe apply jackson-sage");
    ...
    private bool Apply(string input)
    {
        ...
        if (storeRunning)
        {
            ...
            Console.WriteLine("请运行 CodexThemeStore.exe launch，或在双击菜单中确认主题重启。");
            return true;
        }

        Console.WriteLine("Store 版: 主题已保存。运行 CodexThemeStore.exe launch 可按主题模式启动。");
        return true;
    }
